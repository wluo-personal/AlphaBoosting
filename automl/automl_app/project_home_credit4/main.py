...
def params_gen(model='lgb'):
    ...
    if model == 'svc':
        ...
        params = {
            ...
            'max_bin': np.random.choice([1500, 1023, 511, 255]),
...
#             'min_split_gain': np.random.randint(2, 60)/1000,
            ...
            'feature_fraction': np.random.randint(5,30)/100,
            'feature_fraction_seed': seed,
            'early_stopping_round':250,#np.random.randint(150,300),
            'bagging_fraction': np.random.randint(80,101)/100, #Randomly select part of data
            'bagging_seed': seed,
